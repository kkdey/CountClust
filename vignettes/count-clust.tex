...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{batchcorrect.fcounts} \hlkwb{<-} \hlkwd{BatchCorrectedCounts}\hlstd{(}\hlkwd{t}\hlstd{(fcounts.filtered), amp_batch);}
...
##  [4] ggplot2_2.0.0                           
##  [5] GTExV6Brain_0.0.1                       
##  [6] singleCellRNASeqMouseDeng2014_0.99.0    
##  [7] Biobase_2.30.0                          
...
##  [9] evaluate_0.8       highr_0.5.1        stringi_1.0-1      limma_3.26.3      
## [13] labeling_0.3       BiocStyle_1.8.0    RColorBrewer_1.1-2 tools_3.2.2       
## [17] stringr_1.0.0      munsell_0.4.2      colorspace_1.2-6
\end{verbatim}
\end{kframe}
\end{knitrout}
