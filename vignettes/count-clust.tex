...
\vspace{1em}
\textbf{\CountClust{} version:} 0.99.2 \footnote{This document used the vignette from \Bioconductor{} package \Biocpkg{DESeq2, cellTree} as \CRANpkg{knitr} template}
\end{abstract}
...
## [1] CountClust_0.99.2 ggplot2_2.1.0     devtools_1.10.0   knitr_1.12.3     
## 
## loaded via a namespace (and not attached):
##  [1] Rcpp_0.12.3         RColorBrewer_1.1-2  formatR_1.3        
##  [4] git2r_0.14.0        plyr_1.8.3          highr_0.5.1        
##  [7] tools_3.3.0         digest_0.6.9        evaluate_0.8.3     
## [10] memoise_1.0.0       gtable_0.2.0        nlme_3.1-126       
## [13] lattice_0.20-33     mgcv_1.8-12         Matrix_1.2-4       
## [16] curl_0.9.6          parallel_3.3.0      httr_1.1.0         
## [19] stringr_1.0.0       cluster_2.0.3       gtools_3.5.0       
## [22] stats4_3.3.0        grid_3.3.0          nnet_7.3-12        
## [25] cowplot_0.6.1       Biobase_2.30.0      R6_2.1.2           
## [28] maptpx_1.9-2        flexmix_2.3-13      limma_3.26.8       
## [31] reshape2_1.4.1      magrittr_1.5        BiocGenerics_0.16.1
## [34] scales_0.4.0        modeltools_0.2-21   MASS_7.3-45        
## [37] xtable_1.8-2        BiocStyle_1.8.0     picante_1.6-2      
## [40] permute_0.9-0       colorspace_1.2-6    ape_3.4            
## [43] labeling_0.3        stringi_1.0-1       munsell_0.4.3      
## [46] slam_0.1-32         vegan_2.3-4
\end{verbatim}
\end{kframe}
\end{knitrout}
