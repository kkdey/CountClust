...
\vspace{1em}
\textbf{\CountClust{} version:} 0.99.0 \footnote{This document used the vignette from \Bioconductor{} package \Biocpkg{DESeq2, cellTree} as \CRANpkg{knitr} template}
\end{abstract}
...
## [1] CountClust_0.99.0 ggplot2_2.1.0     knitr_1.12.3     
## 
## loaded via a namespace (and not attached):
##  [1] Rcpp_0.12.3        gtools_3.5.0       digest_0.6.9       grid_3.2.4        
##  [5] plyr_1.8.3         gtable_0.2.0       formatR_1.2.1      magrittr_1.5      
##  [9] evaluate_0.8       scales_0.4.0       highr_0.5.1        stringi_1.0-1     
## [13] reshape2_1.4.1     limma_3.26.3       cowplot_0.6.1      labeling_0.3      
## [17] BiocStyle_1.8.0    RColorBrewer_1.1-2 tools_3.2.4        stringr_1.0.0     
## [21] munsell_0.4.3      parallel_3.2.4     colorspace_1.2-6
\end{verbatim}
\end{kframe}
\end{knitrout}
