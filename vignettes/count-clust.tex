%\VignetteIndexEntry{CountClust for visualizing expression}
...
\author{Kushal K Dey\thanks{\email{kkdey@uchicago.edu}}, Chiaowen Joyce Hsiao\thanks{\email{joycehsiao@uchicago.edu}} \& Matthew Stephens\thanks{\email{mstephens@uchicago.edu}} \\ \small{\textit{Stephens Lab}, The University of Chicago} \mbox{ }\\ \small{\texttt{$^*$Correspondending Email: mstephens@uchicago.edu}}}

\bioctitle[\CountClust{} visualizing expression data]{\CountClust{}: Visualizing the structure of RNA-seq expression data using Grade of Membership Models}
...
\packageVersion{CountClust 1.3.1}
...
\hlkwd{download.file}\hlstd{(}
\hlstr{'https://cdn.rawgit.com/kkdey/singleCellRNASeqMouseDeng2014/master/data/Deng2014MouseEsc.rda'}\hlstd{,}
\hlkwc{destfile}\hlstd{=x,} \hlkwc{quiet}\hlstd{=}\hlnum{TRUE}\hlstd{)}
...
\hlstd{x} \hlkwb{=} \hlkwd{tempfile}\hlstd{()}
\hlkwd{download.file}\hlstd{(}
\hlstr{'https://cdn.rawgit.com/kkdey/GTExV6Brain/master/data/GTExV6Brain.rda'}\hlstd{,}
\hlkwc{destfile} \hlstd{= x,} \hlkwc{quiet}\hlstd{=}\hlnum{TRUE}\hlstd{)}
\hlstd{z} \hlkwb{=} \hlkwd{get}\hlstd{(}\hlkwd{load}\hlstd{((x)))}
\hlkwd{return}\hlstd{(z)}
\hlstd{\}}
...
\includegraphics[width=3in,height=7in]{figure/plot_topic_deng-1} \end{adjustwidth}
\end{knitrout}
\end{center}
\end{figure}
...
\hlstd{x} \hlkwb{=} \hlkwd{tempfile}\hlstd{()}
\hlkwd{download.file}\hlstd{(}
\hlstr{'https://cdn.rawgit.com/jhsiao999/singleCellRNASeqMouseJaitinSpleen/master/data/MouseJaitinSpleen.rda'}\hlstd{,}
\hlkwc{destfile} \hlstd{= x,} \hlkwc{quiet}\hlstd{=}\hlnum{TRUE}\hlstd{)}
\hlstd{z} \hlkwb{=} \hlkwd{get}\hlstd{(}\hlkwd{load}\hlstd{((x)))}
\hlkwd{return}\hlstd{(z)}
\hlstd{\}}
...
\end{alltt}
\end{kframe}\begin{adjustwidth}{\fltoffset}{0mm}
\includegraphics[width=3in,height=7in]{figure/plot_topic-1} \end{adjustwidth}
\end{knitrout}
\end{center}
\end{figure}
...
## [1] CountClust_1.3.1 ggplot2_2.2.1    knitr_1.17       devtools_1.13.3 
## 
## loaded via a namespace (and not attached):
##  [1] Rcpp_0.12.13        RColorBrewer_1.1-2  compiler_3.4.1     
##  [4] git2r_0.19.0        plyr_1.8.4          highr_0.6          
##  [7] tools_3.4.1         boot_1.3-20         digest_0.6.12      
## [10] nlme_3.1-131        evaluate_0.10.1     memoise_1.1.0      
## [13] tibble_1.3.4        gtable_0.2.0        lattice_0.20-35    
## [16] mgcv_1.8-22         rlang_0.1.2         Matrix_1.2-11      
## [19] parallel_3.4.1      curl_3.0            yaml_2.1.14        
## [22] cluster_2.0.6       withr_2.0.0         httr_1.3.1         
## [25] stringr_1.2.0       gtools_3.5.0        nnet_7.3-12        
## [28] stats4_3.4.1        rprojroot_1.2       grid_3.4.1         
## [31] cowplot_0.8.0       Biobase_2.37.2      R6_2.2.2           
## [34] maptpx_1.9-3        flexmix_2.3-13      rmarkdown_1.6      
## [37] limma_3.33.14       reshape2_1.4.2      magrittr_1.5       
## [40] BiocGenerics_0.23.4 MASS_7.3-47         backports_1.1.1    
## [43] scales_0.5.0        htmltools_0.3.6     modeltools_0.2-21  
## [46] xtable_1.8-2        permute_0.9-4       ape_4.1            
## [49] picante_1.6-2       BiocStyle_2.5.41    colorspace_1.3-2   
## [52] stringi_1.1.5       lazyeval_0.2.0      munsell_0.4.3      
## [55] SQUAREM_2017.10-1   slam_0.1-40         vegan_2.4-4
\end{verbatim}
\end{kframe}
\end{knitrout}
