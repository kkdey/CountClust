...
#'
#' @description Use null models (popular in ecology) to generate
#'   randomized matrix of counts given the observed data matrix, fit the
#'   GoM model to these null matrices and compare the fit on null model
#'   data with that on the observed data. Used for validating the GoM
#'   clusters.
#'
#' @param counts The counts matrix (N x G): N- the number of samples,
...
#' 
#' @param iter_fill The number of swaps/fills in each randomized
#'   matrix build.
#' 
#' @param iter_randomized The number of randomization matrices
#'   generated.
#' 
